...
class HardwareServicesPage extends StatefulWidget {
  @override
  _HardwareServicesPageState createState() => _HardwareServicesPageState();
}

class _HardwareServicesPageState extends State<HardwareServicesPage> {
  ...
  Future<void> _getCurrentLocation() async {
    ...
    setState(() {
      _currentAddress = '${placemark.street}, ${placemark.locality}, ${placemark.postalCode}';
  ...
  Future<void> _submitForm() async {
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                await logToSupabasehwTable(userId, phone, address, timeSlot, date);
   ...
   logToSupabasehwTable(String userId, String phone, String address, String timeSlot, String date) async {
    final response = await Supabase.instance.client.from('hardwareservice').insert([
      {'userid': userId, 'phone': phone, 'address': address, 'time_slot': timeSlot, 'date': date,'description':_desController.text}
    ]);
  }
