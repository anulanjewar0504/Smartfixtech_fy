...
class ViewRetailerRequestsPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Retailer Requests'),
      ),
...
class RetailerDetailsPage extends StatelessWidget {
  ...
  RetailerDetailsPage({required this.technician});

  Future<void> _updateTechnicianStatus(BuildContext context) async {
    final response = await Supabase.instance.client.from('retailer').update({
      'isVerified': 'true',
    }).eq('id', technician.id);
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('Verify Retailer',style: TextStyle(fontWeight: FontWeight.bold),),
                ),
              ),
            ],
          ),
